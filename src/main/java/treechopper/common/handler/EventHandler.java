...
public class EventHandler {
    ...
    public void OnServerConnect(PlayerEvent.PlayerLoggedInEvent loggedInEvent) {
        TreeChopper.m_Network.sendTo(new ServerSettingsMessage(ConfigurationHandler.reverseShift, ConfigurationHandler.disableShift, ConfigurationHandler.damageAxe), (EntityPlayerMP) loggedInEvent.player);
    }
}
